                    ...
                    <a href="#">
                        ...
                        <Transition name="fade">
                            <ul class="fixed bg-white rounded-md w-1/9 mt-3 p-3 space-y-2 shadow-md" v-if="show_drop">
                                <li>
                                    <router-link to="/settings" class="flex items-center gap-2 rounded-md p-2 hover:bg-gray-100 transition duration-200 active:scale-80">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                ...
                                <li>
                                    <a href="#" @click="signout()" class="flex items-center gap-2 rounded-md p-2 hover:bg-gray-100 transition duration-200 active:scale-80">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
